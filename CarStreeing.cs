...
using UnityEditor;
    ...
    public class CarStreeing : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
    ...
    //ends here
        ...
        float maximumSteeringAngle = 160f;
        float wheelReleasedSpeed = 250f;
        private void Start()
        {
           rect = GetComponent<RectTransform>();
            getcenterPoint();
        uirotation = GetComponent<RectTransform>().rotation;
        ...
        // Carcon.Horizontal = -(UnityEditor.TransformUtils.GetInspectorRotation(rect).z / 80);
        //Debug.Log(""+ rect.transform.rotation.eulerAngles.z );

      //  Debug.Log("rotaton.z" + uirotation.z);//localEulerAngles.z);  
       Carcon.Horizontal = -(uirotation.z );
        }
